...
public class Controller {
    ...
    public static void main(String args[]) {
        ...
        Customer list[] = new Customer[5];  // 顧客リスト
        list[0] = new Corporation("0001", "有川工業",
                                  "福岡県福岡市博多区", "092-345-6789",
                                  "松田重", "製造業");
        list[1] = new Corporation("0002", "土田建設",
                                  "福岡県福岡市中央区", "092-234-6745",
                                  "竹田清弘", "建設業");
        list[2] = new Corporation("0003", "渡辺電器商会",
                                  "福岡県福岡市早良区", "092-987-6789",
                                  "大田康之", "家電販売");
        list[3] = new Individual("0004", "磐田雅夫",
                                 "福岡県福岡市西区", "092-123-5678",
                                 Individual.MARRIED,
                                 Individual.MALE, "会社員");
        list[4] = new Individual("0005", "永田雅子",
                                 "福岡県福岡市博多区",
